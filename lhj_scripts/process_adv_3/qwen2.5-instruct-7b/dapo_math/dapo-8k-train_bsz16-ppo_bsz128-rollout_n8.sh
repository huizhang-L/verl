...
exp_name='verl-dapo-8k-trainbsz16-ppobsz128-rolloutn8-nocritique-noreflection-nostepadv-nosteptopn'
# Paths
...
python3 -m recipe.dapo.main_dapo \
    ...
    custom_reward_function.path="/mnt/shared-storage-user/lvhuijie/my_git_repo/verl/verl/utils/reward_score/hybrid_score_v2.py" \
    ...
    custom_reward_function.llm_process_critique.no_process_reward_when_wrong_answer=False \
    ...
    custom_reward_function.repetition_penalty_cfg.enable=False \
