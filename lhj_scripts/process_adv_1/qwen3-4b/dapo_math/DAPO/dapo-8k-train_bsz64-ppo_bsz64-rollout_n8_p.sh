...
exp_name='dapo-8k-train_bsz64-ppo_bsz64-rollout_n8-process_reward-p'
# Paths
...
python3 -m recipe.dapo.main_dapo \
    ...
    reward_model.reward_manager=modified_dapo \
    ...
    custom_reward_function.llm_judge_process_reward.max_tokens=2048 \
    custom_reward_function.llm_judge_process_reward.concurrency=1 \
