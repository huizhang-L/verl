...
# Custom Reward Score
enable_llm_judge_process_score=True
...
exp_name='dapo-8k-train_bsz64-ppo_bsz64-rollout_n8-process_reward-pp'
# Paths
ckpts_dir="/fs-computility/llm_fudan/lvhuijie/my_git_repo/verl/checkpoints_verl/redundancy/qwen3-4b/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.dapo.main_dapo \
    data.train_files="/fs-computility/llm_fudan/lvhuijie/my_git_repo/verl/data/dapo_math/dapo-math-17k.parquet" \
    ...
    actor_rollout_ref.model.path="/fs-computility/llm_fudan/shared/models/Qwen3/Qwen3-4B" \
    ...
    reward_model.reward_manager="batch_judge_dapo" \
    ...
    custom_reward_function.llm_judge_process_reward.enable=${enable_llm_judge_process_score} \
    custom_reward_function.llm_judge_process_reward.temperature=0.1 \
    custom_reward_function.llm_judge_process_reward.max_tokens=512 \
    custom_reward_function.llm_judge_process_reward.concurrency=128 \
    custom_reward_function.llm_judge_process_reward.coefficient=0.5 \
    custom_reward_function.llm_judge_process_reward.split_step_num=15 \
