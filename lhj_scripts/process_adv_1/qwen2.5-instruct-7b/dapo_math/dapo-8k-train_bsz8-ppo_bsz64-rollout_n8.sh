...
# Custom Reward Score
enable_llm_process_reward=True
...
# WANDB
project_name='verl_process_dapo'
exp_name='process_dapo-8k-train_bsz8-ppo_bsz64-rollout_n8'
# Paths
ckpts_dir="/fs-computility/llm_fudan/lvhuijie/my_git_repo/verl/checkpoints_verl/process_adv_1/qwen2.5-instruct-7b/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.process_dapo.main_process_dapo \
    ...
    custom_reward_function.llm_process_reward.concurrency=128 \
    ...
    custom_reward_function.llm_process_critique.max_tokens=512 \
    custom_reward_function.llm_process_critique.concurrency=128 \
    custom_reward_function.llm_process_critique.coefficient=0.5 \
    custom_reward_function.llm_process_critique.split_step_num=3 \
