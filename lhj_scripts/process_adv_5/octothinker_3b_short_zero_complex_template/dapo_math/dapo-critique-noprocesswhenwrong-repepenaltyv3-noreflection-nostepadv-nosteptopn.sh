...
export LLM_AS_A_JUDGE_SERVICE_URL="http://10.102.246.24:54320/v1"
...
# swanlab
project_name='verl_process_dapo_adv5'
# !!!! 实验名必须以 verl- 开头，不能有下划线
exp_name='verl-dapo-octothinker-complex-template-critique-noprocesswhenwrong-repepenaltyv3-noreflection-nostepadv-nosteptopn'
# Paths
ckpts_dir="/nvme/liaochenyang/checkpoints_verl/process_adv_5/octothinker_3b_short_zero_complex_template/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.process_dapo.main_process_dapo \
    ...
    data.val_files="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/shared_datas/verl_data/skyworkmath/skyworkmath_500_v1.parquet" \
    ...
    custom_reward_function.path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/verl/verl/utils/reward_score/hybrid_score_v4.py" \
    custom_reward_function.eval_path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/verl/verl/utils/reward_score/hybrid_score_v4.py" \
