...
exp_name='dapo-8k-train_bsz64-ppo_bsz64-rollout_n8'
# Paths
...
python3 -m recipe.dapo.main_dapo \
    ...
    reward_model.model.input_tokenizer="${reward_model_path}" \
    reward_model.model.path="${reward_model_path}" \
    reward_model.model.use_remove_padding=True \
    reward_model.use_dynamic_bsz=${use_dynamic_bsz} \
    reward_model.forward_max_token_len_per_gpu=${infer_ppo_max_token_len_per_gpu} \
