...
# Paths
ckpts_dir="/nvme/liaochenyang/mnt/checkpoints_verl/process_adv_6/octothinker_3b_short_zero_complex_template/dapo_math/DAPO/${exp_name}"
...
HYDRA_FULL_ERROR=1 python3 -m recipe.process_dapo.main_process_dapo \
    ...
    data.train_files="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/shared_datas/verl_data/dapo_math/dapomath_en.parquet" \
    ...
    custom_reward_function.llm_process_critique1.coefficient=0.1 \
    ...
    custom_reward_function.llm_process_critique2.coefficient=0.1 \
