...
enable_llm_process_critique=False
...
exp_name='verl-dapo-8k-trainbsz8-ppobsz64-rolloutn8'
# Paths
ckpts_dir="/nvme/lvhuijie/mnt/ailab-llmfudan/checkpoints_verl/outcome_reward/qwen2.5-7b-instruct/dapo_math/DAPO/${exp_name}"
export SWANLAB_LOG_DIR="swanlab/outcome_reward/qwen2.5-7b-instruct/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.dapo.main_dapo \
    ...
    custom_reward_function.path="/mnt/shared-storage-user/lvhuijie/my_git_repo/verl/verl/utils/reward_score/dapo_score.py" \
