...
exp_name='verl-dapo-gpt-oss-20b-high'
# Paths
...
python3 -m recipe.dapo.main_dapo \
    ...
    custom_reward_function.path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/verl/verl/utils/reward_score/dapo_score_with_process_metrics.py" \
    custom_reward_function.eval_path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/verl/verl/utils/reward_score/dapo_score_with_process_metrics.py" \
