...
exp_name='verl-dapo-octothinker-complex-template-critique-noprocesswhenwrong-repepenaltyv2-noreflection-nostepadv-nosteptopn'
# Paths
...
python3 -m recipe.process_dapo.main_process_dapo \
    ...
    custom_reward_function.path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/verl/verl/utils/reward_score/hybrid_score_v3.py" \
    custom_reward_function.eval_path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/liaochenyang/verl/verl/utils/reward_score/hybrid_score_v3.py" \
