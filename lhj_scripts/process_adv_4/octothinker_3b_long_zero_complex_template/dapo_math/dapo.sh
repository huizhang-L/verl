...
exp_name='verl-dapo-octothinker-complex-template'
# Paths
ckpts_dir="/nvme/liaochenyang/checkpoints_verl/process_adv_4/octothinker_3b_long_zero_complex_template/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.dapo.main_dapo \
    ...
    actor_rollout_ref.model.path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/models/OctoThinker/3B/OctoThinker-3B-Long-Zero-complex-template" \
