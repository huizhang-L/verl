...
exp_name='verl-dapo-octothinker-simple-template-critique-noprocesswhenwrong-repepenalty-noreflection-nostepadv-nosteptopn'
# Paths
ckpts_dir="/nvme/liaochenyang/checkpoints_verl/process_adv_4/octothinker_3b_long_zero_simple_template/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.process_dapo.main_process_dapo \
    ...
    actor_rollout_ref.model.path="/mnt/shared-storage-user/shared-storage-ailab-llmfudan/models/OctoThinker/3B/OctoThinker-3B-Long-Zero-simple-template" \
