...
exp_name='verl-dapo-critique-noprocesswhenwrong-norepepenalty-noreflection-nostepadv-nosteptopn'
# Paths
ckpts_dir="/nvme/lvhuijie/mnt/ailab-llmfudan/checkpoints_verl/process_adv_4/qwen2.5-7b-instruct/dapo_math/DAPO/${exp_name}"
