...
# WANDB
project_name='verl_process_dapo_debug'
exp_name='process_dapo-3k-train_bsz2-ppo_bsz16-rollout_n8-debug'
# Paths
ckpts_dir="/fs-computility/llm_fudan/lvhuijie/my_git_repo/verl/checkpoints_verl/process_adv_1/qwen2.5-math-7b-instruct/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.process_dapo.main_process_dapo \
    ...
    actor_rollout_ref.actor.process_grpo_adv.top_n=8 \
