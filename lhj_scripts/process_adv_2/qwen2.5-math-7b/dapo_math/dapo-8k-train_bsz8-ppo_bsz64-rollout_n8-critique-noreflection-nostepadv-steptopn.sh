...
exp_name='dapo-math-8k-train_bsz8-ppo_bsz64-rollout_n8-critique-noreflection-nostepadv-steptopn'
# Paths
ckpts_dir="/fs-computility/llm_fudan/lvhuijie/my_git_repo/verl/checkpoints_verl/process_adv_2/qwen2.5-math-7b-instruct/dapo_math/DAPO/${exp_name}"
...
python3 -m recipe.process_dapo.main_process_dapo \
    ...
    actor_rollout_ref.model.path="/fs-computility/llm_fudan/shared/models/Qwen2.5-Math/Qwen2.5-Math-7B-Instruct" \
    ...
    actor_rollout_ref.actor.process_grpo_adv.top_n=0.2 \
    actor_rollout_ref.actor.process_grpo_adv.topn_mode="truncate" \
    ...
    custom_reward_function.llm_process_critique.presence_penalty=1.5 \
    ...
    custom_reward_function.reflection.presence_penalty=1.5 \
