...
def compute_score(data_source,
    ...
    if llm_reward_cfg.enable:
        ...
        llm_judge_process_score_list = extra_info['process_scores']
        llm_judge_process_score = float(np.mean(llm_judge_process_score_list))
        overall_score = overall_score + llm_reward_cfg.coefficient * llm_judge_process_score
    ...
    if llm_critique_cfg.enable:
        ...
        overall_score = overall_score + llm_critique_cfg.coefficient * llm_critique_score
    return {
        "overall_score": overall_score,
        "outcome_score": outcome_score,
        "process_score": overall_score - outcome_score,
    }
